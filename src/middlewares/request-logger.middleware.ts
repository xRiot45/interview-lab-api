...
export class RequestLoggerMiddleware implements NestMiddleware {
    ...
    use(req: Request, res: Response, next: NextFunction) {
        ...
        res.on('finish', () => {
            ...
            const logMessage = `[Timestamp ${timestamp}] [RequestID: ${requestId}] [${method}] ${process.env.APP_URL}${url} - ${statusCode} ${reasonPhrase} - IP: ${ip} - GeoLocation: ${geoLocation} - UserAgent: ${userAgent} - Duration: ${duration}ms - Referer: ${referer}`;
